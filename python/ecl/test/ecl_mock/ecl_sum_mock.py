...
def createEclSum( case , keys , start = datetime.date(2010 , 1, 1) , sim_length_days = 5 * 365 , num_report_step = 5, num_mini_step = 5, dims = (20,10,5) , func_table = {}):
    ...
    report_step_length = sim_length_days / float(num_report_step)
    mini_step_length = report_step_length / float(num_mini_step)
